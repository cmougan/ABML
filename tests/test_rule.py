...
def test_rule():
    assert_equal(Rule("a <= 10 and a <= 12"), Rule("a <= 10"))
    assert_equal(Rule("a <= 10 and a <= 12 and a > 3"), Rule("a > 3 and a <= 10"))

    assert_equal(Rule("a <= 10 and a <= 10 and a > 3"), Rule("a > 3 and a <= 10"))

    assert_equal(
        Rule("a <= 10 and a <= 12 and b > 3 and b > 6"), Rule("a <= 10 and b > 6")
    )

    assert_equal(len({Rule("a <= 2 and a <= 3"), Rule("a <= 2")}), 1)
    ...
    assert_equal(len({Rule("a <= 3 and b <= 2"), Rule("b <= 2 and a <= 3")}), 1)


def test_hash_rule():
    assert_equal(len({Rule("a <= 2 and a <= 3"), Rule("a <= 2")}), 1)
    assert_not_equal(len({Rule("a <= 4 and a <= 3"), Rule("a <= 2")}), 1)
